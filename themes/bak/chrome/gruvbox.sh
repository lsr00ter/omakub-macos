...
jq '.ntp += {"custom_background_dict":{"background_url": "https://github.com/bweave/omakub-macos/blob/main/backgrounds/ferns-green.jpg?raw=true"}}' Preferences >tmp.json && mv tmp.json Preferences
cd ~ || exit 0
