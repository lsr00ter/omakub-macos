...
DARK_MODE="true"
ITERM_THEME="catppuccin-dawn"
# OMAKUB_THEME_BACKGROUND="catppuccin/background.jpg"
WALLPAPER="catppuccin/background.jpg"
...
if command -v alacritty &>/dev/null; then
  cp "$OMAKUB_PATH/themes/catppuccin/alacritty.toml" ~/.config/alacritty/theme.toml
  touch ~/.config/alacritty/alacritty.toml
fi

# set neovim theme
cp "$OMAKUB_PATH/themes/catppuccin/neovim.lua" ~/.config/nvim/lua/plugins/theme.lua
