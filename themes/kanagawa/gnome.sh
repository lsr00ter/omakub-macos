...
DARK_MODE="true"
ITERM_THEME="kanagawa-dawn"
# OMAKUB_THEME_BACKGROUND="kanagawa/background.jpg"
WALLPAPER="kanagawa/background.jpg"
...
if command -v alacritty &>/dev/null; then
  cp "$OMAKUB_PATH/themes/kanagawa/alacritty.toml" ~/.config/alacritty/theme.toml
  touch ~/.config/alacritty/alacritty.toml
fi

# set neovim theme
cp "$OMAKUB_PATH/themes/kanagawa/neovim.lua" ~/.config/nvim/lua/plugins/theme.lua
