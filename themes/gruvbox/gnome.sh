...
DARK_MODE="true"
ITERM_THEME="gruvbox-dawn"
# OMAKUB_THEME_BACKGROUND="gruvbox/background.jpg"
WALLPAPER="gruvbox/background.jpg"
...
if command -v alacritty &>/dev/null; then
  cp "$OMAKUB_PATH/themes/gruvbox/alacritty.toml" ~/.config/alacritty/theme.toml
  touch ~/.config/alacritty/alacritty.toml
fi

# set neovim theme
cp "$OMAKUB_PATH/themes/gruvbox/neovim.lua" ~/.config/nvim/lua/plugins/theme.lua
