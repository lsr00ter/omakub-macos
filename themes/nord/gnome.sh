...
DARK_MODE="true"
ITERM_THEME="nord-dawn"
# OMAKUB_THEME_BACKGROUND="nord/background.jpg"
WALLPAPER="nord/background.jpg"
...
if command -v alacritty &>/dev/null; then
  cp "$OMAKUB_PATH/themes/nord/alacritty.toml" ~/.config/alacritty/theme.toml
  touch ~/.config/alacritty/alacritty.toml
fi

# set neovim theme
cp "$OMAKUB_PATH/themes/nord/neovim.lua" ~/.config/nvim/lua/plugins/theme.lua
