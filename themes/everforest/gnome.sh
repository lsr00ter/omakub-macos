...
DARK_MODE="true"
ITERM_THEME="everforest-dawn"
# OMAKUB_THEME_BACKGROUND="everforest/background.jpg"
WALLPAPER="everforest/background.jpg"
...
if command -v alacritty &>/dev/null; then
  cp "$OMAKUB_PATH/themes/everforest/alacritty.toml" ~/.config/alacritty/theme.toml
  touch ~/.config/alacritty/alacritty.toml
fi

# set neovim theme
cp "$OMAKUB_PATH/themes/everforest/neovim.lua" ~/.config/nvim/lua/plugins/theme.lua
